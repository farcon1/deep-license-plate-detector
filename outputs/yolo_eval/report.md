...
Для иллюстрации обучения и динамики метрик можно использовать файлы из каталога train-артефактов:

- [`runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/results.png`](runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/results.png)
- [`runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/labels.jpg`](runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/labels.jpg)
- [`runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/PR_curve.png`](runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/PR_curve.png)
- [`runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/F1_curve.png`](runs/detect/outputs/yolo_train/ccpd_base_yolo11n_960/F1_curve.png)
